...
<head>
    ...
    <meta name="description"
        content="Trang web bán laptop <?php echo $row_name['brand_name']; ?> chất lượng với giá cả hợp lý.">
    <meta name="keywords"
        content="laptop <?php echo $row_name['brand_name']; ?>, mua laptop <?php echo $row_name['brand_name']; ?>, giá laptop <?php echo $row_name['brand_name']; ?>">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-6">
                                                <div class="product-item">
                                                    ...
                                                    <a class="d-flex justify-content-center"
                                                        href="productdetail.php?id=<?php echo $row_product['products_id']; ?>">
                                                        <img src="<?php echo $row_product['image']; ?>" width="255" height="195"
                                                            alt="no image" class="product-item__img pd-bottom25">
                                                    </a>
                                                    <div class="rate fl">
                                                        <?php
                                                    ...
                                                    <a href="productdetail.php?id=<?php echo $row_product['products_id']; ?>">
                                                        <h3 class="product-item__name"><?php echo $row_product['products_name']; ?>
                                                        </h3>
                                                    </a>
                                                    <div>
                                                    ...
                                                    <div class="fl spbw product-item__price-wrap">
                                                        <span class="product-item__price"><?php echo $row_product['price']; ?>
                                                            ₫</span>
                                                        <span
                                                            class="product-item__price-old"><?php echo $row_product['discount']; ?>
                                                            ₫</span>
                                                    </div>
                                                </div>
                                            </div>
